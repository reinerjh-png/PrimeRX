...
function openProductModal(btn) {
  ...
  if (modalPresentations)
    modalPresentations.textContent = btn.dataset.presentations || "";
...
document.addEventListener("click", (e) => {
  if (
    modalProducto &&
    modalProducto.classList.contains("flex") &&
...
// =============================================
// 4. ENVÍO DE FORMULARIO DE CONTACTO AJAX
// =============================================
...
if (contactForm && formSuccessOverlay) {
  contactForm.addEventListener("submit", async function (e) {
    ...
    try {
      // Enviar datos hacia Formspree mediante Fetch API
      ...
      if (response.ok) {
        ...
        alert("Ups, ocurrió un problema al enviar tu mensaje. Intenta de nuevo.");
      }
    } catch (error) {
...
if (formResetBtn && formSuccessOverlay) {
